    ...
    <>
      <section className="relative bg-aurora py-20">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center md:px-6">
          <p className="text-sm font-semibold uppercase tracking-wider text-brass-400">The BH Air Duct Cleaning Metro Detroit Blog</p>
      ...
      <LongFormFaq subject="Air Duct Cleaning Knowledge" kind="service" />
